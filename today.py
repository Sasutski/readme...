...
USER_NAME = os.environ['USER_NAME'] # 'Sasutski'
...
if __name__ == '__main__':
    ...
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'Sasutski'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2000, 12, 15))
    ...
    if OWNER_ID == {'id': 'U_kgDOB0wVfw'}: # only calculate for user Sasutski
